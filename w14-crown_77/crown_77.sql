...
--
-- Host: localhost    Database: dbdemo_xx
-- ------------------------------------------------------
...
INSERT INTO `category_xx` VALUES (0,'types'),(1,'hats'),(2,'jackets'),(3,'sneakers'),(4,'womens'),(5,'mens');
...
CREATE TABLE `clothing_xx` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk1_idx` (`cat_id`),
  CONSTRAINT `fk1` FOREIGN KEY (`cat_id`) REFERENCES `category_xx` (`cid`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-12-15 16:21:15
